...
2. Walk through what each score level means concretely for *this* set of opportunities. "Impact = High" means different things for a B2B SaaS tool vs. a consumer mobile app.
