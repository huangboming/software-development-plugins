---
name: write-prd
description: "Generate product-level or feature-level PRDs. Triggers: 'write a PRD', 'create a product spec', 'spec out this feature', 'I need a PRD for...', 'collect requirements', 'write requirements', 'write user stories', 'document requirements from code', '/write-prd'."
---
