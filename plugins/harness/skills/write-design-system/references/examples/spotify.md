...
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/spotify), MIT licensed.
>
> **Why this example**: vibrant green on dark, bold type, media-driven. Demonstrates how a single saturated accent operates against a near-black canvas, album-art-friendly compositions, and the consumer-media archetype. Read this when designing for streaming, entertainment, or any media-rich consumer product.
