...
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/stripe), MIT licensed.
>
> **Why this example**: chromatic gradient + fintech polish. Demonstrates weight-300 elegance, blue-tinted multi-layer shadows, OpenType `"ss01"` brand stylistic set, and the rare "premium light theme" archetype. Read this when designing for fintech, API products, or any brand-forward marketing system that wants to feel both technical and luxurious.
