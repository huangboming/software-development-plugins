...
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/notion), MIT licensed.
>
> **Why this example**: warm minimalism with serif headings and soft surfaces. Demonstrates how serif display type pairs with clean sans body, the "warm gray" alternative to cool gray, and the soft surface stack used for productivity and content tools. Read this when designing for productivity, knowledge work, content, or any writing-oriented product.
