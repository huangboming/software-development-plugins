...
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/vercel), MIT licensed.
>
> **Why this example**: clean, light, restrained marketing system. Demonstrates the shadow-as-border technique, multi-layer shadow stacks, three-weight Geist hierarchy, and workflow-specific accent colors. Read this when designing for marketing sites, developer infrastructure, or any system that wants gallery-level emptiness.
