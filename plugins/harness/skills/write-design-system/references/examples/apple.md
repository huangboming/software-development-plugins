...
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/apple), MIT licensed.
>
> **Why this example**: premium spacious editorial. Demonstrates the SF Pro hierarchy, cinematic full-bleed imagery, generous negative space as a luxury signal, and the tightly-restrained palette of premium hardware brands. Read this when designing for hardware, consumer brands, or any site that leans on photography and negative space.
