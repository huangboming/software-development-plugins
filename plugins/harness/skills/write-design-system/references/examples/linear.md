...
> Source: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/linear.app), MIT licensed.
>
> **Why this example**: dense, dark, technical B2B tool. Demonstrates evocative naming (*Marketing Black*, *Brand Indigo*, *Security Lavender*), per-variant button recipes, semi-transparent border conventions, and elevation-via-luminance for dark systems. Read this when designing for developer tools, dashboards, or any dense dark UI.
